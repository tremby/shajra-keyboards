...
```
    ...
    FLASH SOURCE: /nix/store/9wi5px0nc3picbm10dbvd9mqsy6pl6xs-qmk-builtin-shajra-src
    FLASH BINARY: /nix/store/ryab0wg14cfnz9p8avzw41qzvr04aw0i-ergodoxez-builtin-shajra.hex
...
```
    ...
    /nix/store/zhams7xqrh8sy3xwnw7ifm5386zmd3fp-shajra-keyboards-checks
    ├── build-ergodoxez-builtin-shajra-flash -> /nix/store/avy18zyc7wbvvrw33cs3d8800d678dwz-ergodoxez-builtin-shajra-flash-env
    ├── build-ergodoxez-builtin-shajra-hex -> /nix/store/ryab0wg14cfnz9p8avzw41qzvr04aw0i-ergodoxez-builtin-shajra.hex
    ├── build-ergodoxez-factory-flash -> /nix/store/666dww14wilgw9wwv8j9b5ynr6fbafnc-ergodoxez-factory-flash-env
    ├── build-ergodoxez-factory-hex -> /nix/store/c9f75605rv18pw4ik4wc3k5llka8lqnq-ergodoxez-factory.hex
    ├── build-model01-builtin-shajra-flash -> /nix/store/1kjvkbpanjgicd2agclgliy6fg609qcg-model01-builtin-shajra-flash-env
    ├── build-model01-builtin-shajra-hex -> /nix/store/73g15lwfc2nj0786dhhfnl5s98agpybm-model01-builtin-shajra-hex
    ├── build-model01-factory-flash -> /nix/store/icqal9aavmhyr81cfwb0zk1jb84ilf17-model01-factory-flash-env
    ├── build-model01-factory-hex -> /nix/store/n9v4lz2b2ka4iwix6513flmsjgwg7imq-model01-factory-hex
    ├── build-model100-builtin-shajra-flash -> /nix/store/r80qj3604ywy4xg516sgnhmxxhpvdm10-model100-builtin-shajra-flash-env
    ├── build-model100-builtin-shajra-hex -> /nix/store/0i06klrx042m2fpnxlhircrqr3ww6xw8-model100-builtin-shajra-hex
    ├── build-model100-factory-flash -> /nix/store/8xypxkjglwgd9qpgfkwy94rhik712gz4-model100-factory-flash-env
    ├── build-model100-factory-hex -> /nix/store/2n4zldz32vm4ha7qn6a33d0r3p6bnax8-model100-factory-hex
    ├── build-moonlander-builtin-shajra-flash -> /nix/store/fhkmjd55njkrd96snqbfssgxfa1g7bm3-moonlander-builtin-shajra-flash-env
    ├── build-moonlander-builtin-shajra-hex -> /nix/store/wl9xnb0f401s8gy35w3x2snal58kkqr3-moonlander-builtin-shajra.bin
    ├── build-moonlander-factory-flash -> /nix/store/1gzl41kiafgpzcq90l7a0qnpgc4fy3j3-moonlander-factory-flash-env
    ├── build-moonlander-factory-hex -> /nix/store/8qrz5sy05a98qvif4gb6r9psayxajg1p-moonlander-factory.bin
    ├── flash-ergodoxez -> /nix/store/andcsv293j2y6syxwy7msz1kq9h26im1-flash-ergodoxez-env
    ├── flash-model01 -> /nix/store/3dv48m49zsjkgcvsdd7iyjx5m7wsx7d8-flash-model01-env
    ├── flash-model100 -> /nix/store/dqa6s4f969h33kl43y19miczijyxicg2-flash-model100-env
    ├── flash-moonlander -> /nix/store/ngnvdwj7wvn7vyn303ia70i37xrx37ww-flash-moonlander-env
    ├── licenses -> /nix/store/qmn4837bc6swdkl58n38jaqp6lpw0gsa-shajra-keyboards-licenses-env
    ├── support-arduino-upgrade -> /nix/store/3mbvzgvkmffaqqmwxi8gigm075lp1czb-arduino-upgrade-env
    └── support-kaleidoscope-deps -> /nix/store/ram7gr2c3w9dlvsxnamri5rhyy123xr3-kaleidoscope-deps-env

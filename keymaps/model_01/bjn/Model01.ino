...
KEYMAPS(
  ...
  (Key_F24,	Key_1,	Key_2,	Key_3,	Key_4,	Key_5,	Key_LEDEffectNext,
   ...
   LockLayer(GAMING),	Key_6,	Key_7,	Key_8,	Key_9,	Key_0,	LockLayer(NUMPAD),
   Key_Enter,	Key_F,	Key_G,	Key_C,	Key_R,	Key_L,	Key_Slash,
...
#error "No default keymap defined. You should make sure that you have a line like '#define PRIMARY_KEYMAP_QWERTY' in your sketch"
  ...
  (___,	LGUI(LSHIFT(Key_1)),	LGUI(LSHIFT(Key_2)),	LGUI(LSHIFT(Key_3)),	LGUI(LSHIFT(Key_4)),	LGUI(LSHIFT(Key_5)),	___,
   ___,	LGUI(LCTRL(LALT(Key_Quote))),	LGUI(LCTRL(LALT(Key_Comma))),	LGUI(LCTRL(LALT(Key_Period))),	LGUI(LCTRL(LALT(Key_P))),	LGUI(LCTRL(LALT(Key_Y))),	LGUI(LSHIFT(Key_Enter)),
   LGUI(Key_KeypadAdd),	___,	LGUI(Key_O),	___,	___,	___,	/* No key */
   LGUI(Key_KeypadSubtract),	___,	___,	LGUI(Key_J),	LGUI(Key_K),	___,	LGUI(LSHIFT(Key_C)),
   ___, ___, ___, ___,
   ___,

   ___,	LGUI(LSHIFT(Key_6)),	LGUI(LSHIFT(Key_7)),	LGUI(LSHIFT(Key_8)),	LGUI(LSHIFT(Key_9)),	___,	___,
   LGUI(Key_Enter),	LGUI(Key_F),	LGUI(LSHIFT(Key_H)),	LGUI(LSHIFT(Key_K)),	LGUI(LSHIFT(Key_L)),	LGUI(LCTRL(LALT(Key_L))),	___,
   /* No key */	LGUI(LCTRL(LALT(Key_C))),	LGUI(Key_H),	LGUI(LSHIFT(Key_J)),	LGUI(Key_L),	___,	___,
   LGUI(Key_R),	___,	LGUI(LCTRL(Key_H)),	___,	LGUI(LCTRL(Key_L)),	___,	___,
   ___, ___, ___, ___,
   ___),
  ...
  (___,	___,	___,	___,	___,	___,	___,
   ...
   /* No key */	___,	Key_1,	Key_2,	Key_3,	Key_Equals,	___,
  ...
  (___,	___,	___,	___,	___,	___,	___,
   ...
   ___,	Key_LeftShift,	Key_A,	Key_S,	Key_D,	Key_F,	/* No key */
   ___,	___,	Key_Z,	Key_X,	Key_C,	Key_V,	___,
   Key_LeftControl, Key_Spacebar, Key_LeftAlt, ___,
   ShiftToLayer(FUNCTION),
...
static kaleidoscope::plugin::LEDSolidColor solidYellow(130, 130, 0);
...
void setup() {
  ...
  // Wavepool configuration
  //WavepoolEffect.idle_timeout = 5e3;

...
For all keyboards, The “shajra” keymap is in its own directory. You can make
your own keymap and put it in a sibling directory with the name of your choice,
and it will be compiled in as well.

If you don't want to use keymaps compiled into the flashing scripts, you can
point to another directory of keymaps outside the project at runtime with the =-K=
/ =-keymaps= switch.

Whether using the builtin keymaps or pointing to your own directory, you then
use the =-k= / =--keymap= switch to load your custom keymap by the name you chose
for the keymap in the keymaps directory.  The scripts should pick up changes,
rebuild anything necessary, and flash your keyboard.

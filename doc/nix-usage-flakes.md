...
```
    ...
    /nix/store/s8yl6gkg21b86rnyfwvz4b2mcdayqjvi-shajra-keyboards-licenses-env
...
```
    ...
    /nix/store/s8yl6gkg21b86rnyfwvz4b2mcdayqjvi-shajra-keyboards-licenses-env/bin/shajra-keyboards-licenses
...
```
    ...
    Store paths:        /nix/store/s8yl6gkg21b86rnyfwvz4b2mcdayqjvi-shajra-keyboards-licenses-env
